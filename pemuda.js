...
const cekafk = (_dir) => {
    setInterval(() => {
		...
		const ovo = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE OVO 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/Juna.jpg'),sourceUrl:"https://bit.ly/ScanDisini"}}})
		}
		const dana = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/Juna.jpg'),sourceUrl:"https://bit.ly/ScanDisini"}}})
		}
		const gopay = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/Juna.jpg'),sourceUrl:"https://bit.ly/ScanDisini"}}})
		}
...
try {
  ...
  if (blocked.length > 2) return
		...
		const dfrply = fs.readFileSync('./media/image/Juna.jpg')
		cmhit.push(command)
        mess = {
			wait: '_「🪀」 Sabar yah sabarr, Permintaan Sedang di Proses_',
			...
			only: {
				group: '_「🪀」 Error, Hanya  Bisa di Gunakan Dalam Grup_',
				ownerG: '_「🪀」 Error, Hanya  Bisa di Gunakan Oleh Owner Grup_',
				ownerB: '_「🪀」 Error, Hanya  Bisa di Gunakan Oleh Owner Bot_',
				admin: '_「🪀」 Error, Hanya  Bisa di Gunakan Oleh Admin Grup_',
				Badmin: '_「🪀」 Error, Hanya  Bisa di Gunakan Ketika Bot jadi Admin Grup_',
			}
		}
...
const isAntiVO = isGroup ? antiviewonce.includes(from) : false	
		...
		const katalog = (teks) => {
             res = pemuda.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "© Juna-bot", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             pemuda.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = pemuda.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/BhLJ7fd7rTS8rNH7pPPvQq', "groupName": `${NamaBot}`, "footerText": "© Juna-bot", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const sendreply = (from, teks, faketeks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./media/image/Juna.jpg'), surface: 200, message: `Juna bot`, orderTitle: `Juna bot`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true }})
...
pemuda.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "© Juna-bot", [{buttonId: 'simi', buttonText: {disText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
	...
	//•======>> SUBSCRIBE : Juna bot <<====•\\
        ...
        const sendWebp = async(from, url) => {
	        ...
	        pemuda.sendMessage(from, { disname: nama, vcard: vcard}, MessageType.contact, {contextInfo: {"mentionedJid": ane}})
				...
				const reply = (teks) => {
			pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hai ${pushname}`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/6285693352917?text=Assalamualaikum%20Kakak%20Juna%20yang%20Ganteng`}}})
		}
		const simir = (teks) => {
...
_Jika Ingin Melihat Semua Menu ${NamaBot} Silahkan Klik Yang Di Bawah_`,
 sections: [
                     {
 ...
 rows: [
                          {
                              "title": "infobot",
                              "description" :"Klik Ini Untuk Melihat Beberapa Informasi Bot",
                              "rowId": ""
                          },
                          {
                              "title": "rules",
                              "description" :"Klik Ini Untuk Melihat Rules Yang Harus Dipatuhi Jika Ingin Menggunakan Bot",                              
                              "rowId": ""
                           },
                           {
                              "title": "allmenu",
                              "description" :"Klik Ini Untuk Melihat Seluruh Fitur Bot Yang Ada",
                              "rowId": ""
                           },
                           {
                              "title": "owner",
                              "description" :"Klik Ini Untuk Melihat Kontak Owner",
                              "rowId": ""
                           },
                           {
                              "title": "status",
                              "description" :"Klik Ini Untuk Melihat Beberapa Status Bot",
                              "rowId": ""
                           },
                           {
                              "title": "sewa",
                              "description" :"klik Ini Jika Anda Ingin Menyewa Bot",
                              "rowId": ""
                           }
                        ]
                     }],
...
case 'sewa':
       ...
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 👋🏻_* \n\nyakin nih mau sewa bot ? 🤔 Boong auto banned >_<`, "*Juna bot © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa1`,buttonText:{displayText:'🗿Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'sewa1':
 listMsg = {
 buttonText: 'KLIK DISINI',
 footerText: '*Juna bot © 2021*',
...
case '🕔sewa':
       ...
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*Juna bot © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}py`,buttonText:{displayText:'NOMOR 📱'},type:1},{buttonId:`${prefix}qrsewa`,buttonText:{displayText:'QR CODE 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'py':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*Juna bot © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}o1`,buttonText:{displayText:'OVO 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'GOPAY 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qrsewa':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `_Hai ${pushname}🌹_\n\nSilahkan pilih metode pembayaran`, "*Juna bot © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}qrg1`,buttonText:{displayText:'QR GOPAY 📱'},type:1},{buttonId:`${prefix}qro1`,buttonText:{displayText:'QR OVO 📱'},type:1},{buttonId:`${prefix}qrd1`,buttonText:{displayText:'QR DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qro1':
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE OVO",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/Juna.jpg'),sourceUrl:"OV1876"}}})
break
case 'qrg1':
pemuda.sendMessage(from, `*[🪀] OPEN SEWA BOT*
╭───────────────
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE GOPAY",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/Juna.jpg'),sourceUrl:"GPY18ui876"}}})
break
case 'qrg1':
pemuda.sendMessage(from, `*[🪀] OPEN SEWA BOT*
╭───────────────
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE DANA",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/Juna.jpg'),sourceUrl:"DNA187736"}}})
break
case 'o1':
menu = `*[🪀] OPEN SEWA BOT*
╭───────────────
...
case 'sewaff2':
       ...
       menu = `0`
sendButLocation(from, `_Hai ${pushname}_\n\nSilahkan pilih metode pembayaran`, "Juna bot © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa2`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
///===== PEMBATAS SEWA ====\\\
//// PEMBATAS MENU OWNER \\\
case 'ban':
...
case 'grupofc':
case 'gcofc':
pemuda.sendMessage(from, { text: "Hai Kak, Berikut Link Grup Official Juna-bot\n\nhttps://chat.whatsapp.com/BhLJ7fd7rTS8rNH7pPPvQq \n\n_Jangan Lupa Join Ya Kak_", matchedText: 'https://chat.whatsapp.com/BhLJ7fd7rTS8rNH7pPPvQq', description: "", title: "Klik Disini Kak", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
break
case 'creategroup':
			case 'creategrup':
...
const btnbc = {
    ...
    footerText: 'Broadcast Juna bot © 2021',
    buttons: buttons,
    headerType: 1
}
...
client.browserDescription = ['Juna bot','Desktop','3.0']
...
pemuda.sendMessage(from, img, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/Juna.jpg')})
break
case 'tahta': 
...
pemuda.sendMessage(from, anu, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/Juna.jpg')})
break
case 'nuliskanan':
if (!c) return reply('Textnya mana gan?')
reply(mess.wait)
...
//Xchillds
case 'maker2d2': 
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} Juna bot`)
					makell = args.join(" ")
					reply(mess.wait)
					anu = await fetchJson(`https://api-xchillds.herokuapp.com/api/maker2?text=${makell}&apikey=${xchillds}`)
					buffer1 = await getBuffer(anu.result.results)
					pemuda.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./media/image/Juna.jpg')})
					break
		case 'maker2d3': 
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} Juna bot`)
					makell = args.join(" ")
		...
		case 'maker2d4': 
			...
			case 'transformer': 
					...
					buffer1 = await getBuffer(anu.result.results)
					pemuda.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./media/image/')})
					break
               case 'googletxt':
                  if (args.length < 1) return reply(`*Example :*\n${prefix}${command} juna|chan|kawai`)
             makell = args.join(" ")
             ll1 = makell.split("|")[0];
             ll2 = makell.split("|")[1];
             ll3 = makell.split("|")[0];
...
case 'trigger':
		...
		case 'gay':
             ...
             case 'stickmeme':
               case 'smeme':
             if(!c) return reply(`Example :Reply sticker dengan Caption${prefix + command} juna` )
...
if (!isQuotedSticker) return reply(`Reply Stikernya`)
	...
	pempa = anee[0] !== "" ? anee[0] : `It's Me Juna`;
	autpa = typeof anee[1] !== "undefined" ? anee[1] : `YT : Biru1`;
...
case 'ppcp': 
   ...
   sendButImage(from, pll, `Juna-bot © 2021`, cewe, [                      
          {
...
break
    ...
    hmm4 = fs.readFileSync(`./media/image/Juna.jpg`)
...
case 'x':
  if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
            ...
            "externalAdReply": {
                ...
                "thumbnail": fs.readFileSync(`./media/image/Juna.jpg`),
                "sourceUrl": "https://youtu.be/x-O0WHkv3uc"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        pemuda.toggleDisappearingMessages(from, 0)
        sendButLocation(from, `${ngazap(prefix)}`, `${virtag(prefix)}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bbaij72njnwjibdo16830nslm1782`,buttonText:{disText:'⚔️ Juna bot ⚔️'},type:1}])
        pemuda.toggleDisappearingMessages(from, 0)
break
case 'bugrow':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
break
case 'bugtrolites':
 const pemuda6 = fs.readFileSync(`./media/image/Juna.jpg`)
...
pemuda.sendMessage(from, goo, image, {quoted: fvid, caption: 'Nih Jangan Lupa Col*i Ya Bwang'})
break
case 'cecanrandom':
...
pemuda.sendMessage(from, kon, video, { quoted: mek, thumbnail: fs.readFileSync('./media/image/Juna.jpg')})
break
...
pemuda.sendMessage(from, kon, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/Juna.jpg')})
break
case 'lesbian':
if (!isGroup) return reply(mess.only.group)
	if (!isBotGroupAdmins) return reply(mess.only.Badmin)
...
pemuda.sendMessage(from, hai, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/Juna.jpg')})
break
case 'wallpaper':
if (!isGroup) return reply(mess.only.group)
	if (!isBotGroupAdmins) return reply(mess.only.Badmin)
...
pemuda.sendMessage(from, buffer, image, { quoted: mek, thumbnail: fs.readFileSync('./media/image/Juna.jpg')})
break
case  'blowjob':
if (!isGroup) return reply(mess.only.group)
	if (!isBotGroupAdmins) return reply(mess.only.Badmin)
...
- Wit : ${timeWit}  
- Hari : ${week} ${weton}
- Tanggal : ${calender}`,sendButLocation(from,  `${menu}`, `${uwu}© Juna bot ${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa`,buttonText:{displayText:'SEWA BOT🔥'},type:1}, {buttonId:`${prefix}gcofc`,buttonText:{displayText:'GRUP OFFICIAL👥'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case "report":
  case "reportbug":
    case "bugreport":
...
break
		case 'instainfo':
		pemuda.sendMessage(from, { text: "Hai kak , Pemilik Bot Tidak Mempunyai Instagram:v", matchedText: 'https://instagram.com/', description: "", title: "KLIK UNTUK FOLLOW", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'youtubeinfo':
		pemuda.sendMessage(from, { text: "Hai kak, Pemilik Bot tidak punya YT:v", matchedText: 'https://youtube.com', description: "", title: "KLIK UNTUK SUBCRIBE", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
...
Giliran = @${tty.er1.split('@')[0]}`
 ...
 //•======>> SUBSCRIBE : Juna bot <<====•\\
     ...
     pemuda.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Pemuda Bot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/Juna.jpg'),sourceUrl:"https://youtu.be/x-O0WHkv3uc"}}})
	}
    }
    }
    }
